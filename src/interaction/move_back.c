...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/05 00:22:19 by dpattij           #+#    #+#             */
/*   Updated: 2020/01/05 01:34:02 by dpattij          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_back(t_draw_obj *drawer)
{
	...
	camera->cframe = mat4_addv(camera->cframe, vec3_unm(mat4_look_vec(rel)));
	drawer->last_action = "Moved backwards";
}
